...
def train():
    ...
    sim_loss_fn = losses.NMI(bin_centers = bin_centers, vol_size=(16,512,512)).loss
    grad_loss_fn = losses.gradient_loss

    # Get all the names of the training data

    """ RESECT """
    DS = Dataset(["../../Dataset/RESECT/resize_affine/train/*/*T1.nii",
                  "../../Dataset/RESECT/resize_affine/train/*/*FLAIR.nii"])
    """ jzl """
    # DS = Dataset(["../../Dataset/jzl/train/*/*t1*.nii",
    #           "../../Dataset/jzl/train/*/*t2*.nii"])
